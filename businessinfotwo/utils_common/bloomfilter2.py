...
class BloomFilter(object):
    def __init__(self, host=REDISDB[CONRENT_CONF]["REDIS_HOST"], port=REDISDB[CONRENT_CONF]["REDIS_PORT"], db=REDISDB[CONRENT_CONF]["REDIS_DB"], blockNum=1,password=REDISDB[CONRENT_CONF]["REDIS_PASSWORD"], key='bloomfilter:bloomfilter'):
