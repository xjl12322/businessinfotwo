...
from conf import *
REDIS_HOST = REDIS[CURRENT_CONFIG]["host"]
REDIS_PORT = REDIS[CURRENT_CONFIG]["port"]
REDIS_DB = REDIS[CURRENT_CONFIG]["db"]
REDIS_PASSWORD = REDIS[CURRENT_CONFIG]["password"]
...
class BloomFilter(object):
    def __init__(self, host=REDIS_HOST, port=REDIS_PORT, db=REDIS_DB, blockNum=1,password=REDIS_PASSWORD, key='bloomfilter:bloomfilter'):
    # def __init__(self, host='localhost', port=6379, db=0, blockNum=1, password='xinnet123',
    #                  key='bloomfilter:bloomfilter'):
        """
